	...
	<div class="container sub noUnauthorizedEmail etc" data-navi-name="noUnauthorizedEmail">

		<!--#include virtual="/ty/html/mobile/include/etc/etcLnbD2.asp"-->

		<div class="section etc">
			<h5>이메일 무단 수집거부</h5>
			<p>본 웹사이트에 게시된 이메일 주소가 전자우편수집 프로그램이나  그밖의 기술적 장치를 이용하여 무단으로 수집되는 것을 거부하며, 이를 위반 시 정보통신망 이용촉진 및 정보보호 등에 관한 법률에  의해 처벌 받을 수 있습니다.</p>

			<p class="title">제50조의2 (전자우편주소의 무단 수집행위 등 금지)</p>
			...
			<p class="title">제74조 (벌칙) 다음 각호의 1에 해당하는 자는 1천만원 이하의 벌금에 처한다.</p>
			<ol class="olType_01 no">
	...
	</div> <!-- container sub noUnauthorizedEmail :: end -->
