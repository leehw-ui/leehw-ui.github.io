	...
	<div class="content">
		...
		<div class="listArea">
					...
					<div class="historyBox">			                       
						...
						<div class="historyList">
							<div class="info">
								...
								<p>주문번호:200313131</p>
								<a href="orderCancelDetail.asp" class="orderDtGobtn">주문상세보기</a>
							</div>
							...
							<div class="prodBox">
								...
								<div class="prodThumb">
									...
									<div class="btnArea">
										<p class="state">취소신청</p>
										<p class="date">2020.02.16 14:12:00</p>
									</div>
								</div>
							</div>
							<!-- 상품주문리스트 prodBox :: end -->
			...
			<div class="processArea">
				<div class="processBox processBox02">
					<p class="lineTxt02">주문 취소 진행 단계</p>
					<div class="processList">
						<ul>
							<li>
								...
								<div class="stepDesc">
									<p class="descTit">취소신청</p>
									<p class="descTxt">
										<span>주문/결제 상태<br />에서만 가능</span>
									</p>
								</div>
							</li>
							<li>
