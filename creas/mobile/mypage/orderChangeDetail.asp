                           ...
                           <div class="historyList">
                               ...
                               <div class="prodBox">
                                    ...
                                    <div class="prodThumb">
                                       ...
                                       <div class="btnArea">
                                           <p class="state">교환신청</p>
                                           <p class="date">2020.02.11 14:12:00</p>
                                       </div>
                                   </div>
                               </div>
                               <!-- 상품주문리스트 prodBox :: end -->
                               ...
                               <div class="prodBox">
                                    ...
                                    <div class="prodThumb">
                                       ...
                                       <div class="btnArea">
                                           <p class="state">교환발송</p>
                                           <a href="javascript:void(0);" class="btn white delivertChBtn">배송 조회</a>
                                       </div>
                                   </div>
                               </div>
                               <!-- 상품주문리스트 prodBox :: end -->
                    ...
                    <div class="infoBox">
                       ...
                       <table class="tableList01">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>상세 내용</th>
                                    <td>두개 사이즈 모두 L로 변경해서 교환해 주세요.</td>
                                </tr>
                                <tr>
                                    <th>상품 발송일</th>
                                    <td>2020.02.10</td>
