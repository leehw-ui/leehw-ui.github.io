...
<main class="sub etc">
	...
	<div class="content">
		<div class="box">
			...
			<div class="box01">
				<h5>제1조(목적)</h5>
				<p>이 약관은 (주)크리스에프앤씨(이하 “회사”라 한다)가 운영하는 (주)크리스에프앤씨 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리•의무 및 책임사항을 규정함을 목적으로 합니다.
			...
			<div class="box01">
				...
				<ol class="termsOlist01 round">
					<li>“몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호•모사전송번호•전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자 등을 이용자가 쉽게 알 수 있도록 (주)크리스에프앤씨 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</li>
			...
			<div class="box01">
				...
				<ol class="termsOlist01 round">
					...
					<li>사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 “몰”은 제8조에 정한 방법으로 이용자에게 통지하고 당초 “몰”에서 제시한 조건에 따라 소비자에게 보상합니다. 다만, “몰”이 보상기준 등을 고지하지 아니한 경우에는 이용자들의 마일리지  등을 “몰”에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.</li>
				</ol>
			</div><!-- box01 5 :: end -->
			...
			<div class="box01">
				...
				<ol class="termsOlist01 round">
					...
					<li>
						...
						<br>5. 회원이 자발적인 의사로 회원탈퇴를 한 후 3개월이 지나지 아니한 경우
					</li>
					<li>회원가입계약의 성립 시기는 “몰”의 승낙이 회원에게 도달한 시점으로 합니다.</li>
					<li>회원은 회원가입 시 등록한 사항에 변경이 있는 경우, 상당한 기간 이내에 “몰”에 대하여 회원정보 수정 등의 방법으로 그 변경사항을 알려야 하며, 이를 이행하지 않아 발생한 불이익은 회사가 부담하지 않습니다.</li>
			...
			<div class="box01">
				...
				<ol class="termsOlist01 round">
					<li>회원은 “몰”에 언제든지 탈퇴를 요청할 수 있으며 “몰”은 즉시 회원탈퇴를 처리합니다. 다만 이미 체결된 거래계약의 완결이 필요한 경우에는 이 약관이 계속 적용됩니다.</li>
					<li>
						...
						<br>5. 서비스의 이용과정에서 회사의 직원에게 폭언, 협박 또는 음란한 언행 등 부적절한 방법으로 회사의 업무를 방해하는 경우
						<br>6. 재화 등을 구매한 후 정당한 이유 없이 상습적으로 취소, 교환 및 반품하여 회사의 업무를 방해하는 경우
					</li>
					<li>
						회원이 다음 각호의 사유에 해당하는 경우, “몰”은 회원자격을 상실시킬 수 있습니다.
						<br>1. “몰”이 회원 자격을 제한, 정지시킨 후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우
						<br>2. 상품 재판매 등의 목적으로 대량으로 재화 등을 구매하여 건전한 상거래 질서를 해하는 경우
					</li>
					<li>
						“몰”이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고, 회원등록 말소 전에 최소한 30일 이상의 기간을 정하여 소명할 기회를 부여합니다.
						<br>□  몰 회원이 1년 이상 몰 사이트에 로그인하지 않는 경우 해당 회원의 계정은 휴면계정으로 전환되며 이후 다시 서비스를 이용하고자 할 경우 로그인 등 확인절차를 거쳐야 합니다.
					</li>
				</ol>
			</div><!-- box01 7 :: end -->
			...
			<div class="box01">
				...
				<ol class="termsOlist01 round">
					<li>
						“몰”은 제9조와 같은 구매신청에 대하여 다음 각 호에 해당하면 승낙하지 않을 수 있습니다. 다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자 본인 또는 법정대리인이 당해 계약을 취소할 수 있습니다.
					...
					<li>계약이 성립한 후 “몰”은 제1항의 각호를 발견한 경우 “몰”은 즉시 계약을 취소할 수 있으며,계약 취소시 이용자가 결제한 상품 대금은 즉시 환불처리됩니다.</li>
				</ol>
			</div><!-- box01 10 :: end -->

			<div class="box01">
				<h5>제11조(지급방법)</h5>
				<p>“몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의 방법 중 가용한 방법으로 할 수 있습니다. 단, “몰”은 재화 등의 종류에 따라 일부 대금지급방법의 이용에 제한이 있을 수 있습니다.</p>
				<p>
			...
			<div class="box01">
				<h5>제15조(청약철회 등)</h5>
				<ol class="termsOlist01 round">
					<li>“몰”과 재화 등의 구매에 관한 계약을 체결한 이용자는 수신확인의 통지를 받은 날부터 7일 이내에는 청약의 철회를 할 수 있습니다.</li>
					<li>
			...
			<div class="box01">
				<h5>제17조 마일리지, 쿠폰 제도의 운영</h5>
				<ol class="termsOlist01 round">
					<li>“몰”은 회원에게 마일리지, 쿠폰 제도를 운영할 수 있습니다.</li>
					<li>마일리지는 “몰”이 회원에게 재화 등을 구매시 또는 이벤트 참여시 경품 등 “몰”의 정책에 따라 부여하는 결제수단을 말합니다.</li>
					<li>쿠폰은 “몰”의 정책에 따라 일정액 또는 일정비율을 할인 받을 수 있는 수단을 말합니다</li>
					<li>마일리지, 쿠폰의 획득, 사용 방법 등에 관련된 세부이용지침은 서비스에 따라 별도로 마련하여 고지한 절차 또는 세칙에 따릅니다.</li>
					<li>마일리지, 쿠폰은 재화 등을 구매시 단독으로 (쿠폰 제외) 또는 다른 결제수단과 결합하여 사용할 수 있으나, 사전에 “몰”이 사용이 불가능하다고 고지한 재화 등에 대해서는 사용을 할 수 없습니다.</li>
					<li>이용자는 마일리지, 쿠폰을 본인의 거래에 한하여 이용할 수 있으며, 타인에게 매매 또는 양도 등의 행위를 할 수 없습니다.</li>
					<li>이용자가 부당 또는 부정한 방법으로 마일리지, 쿠폰을 취득하거나 사용한 사실이 확인될 경우 이용자는 이를 사용할 수 없으며 이로 인해 발생하는 모든 법률적인 책임을 부담합니다. 이 경우 “몰”은 이용자의 마일리지, 사이버 머니, 쿠폰의 회수, 회원자격의 상실 및 형사 고발 등 기타 필요한 조치를 취할 수 있습니다.</li>
					<li>마일리지의 적립, 사용, 정정 및 취소, 환원 및 차감, 일시중지, 유효기간 등의 서비스 정책은 (주)크리스에프앤씨 사이버몰 이용약관에 따라 적용됩니다.</li>
					<li>당해 상반기(1~6월) 및 하반기(7~12월)에 적립된 적립금 중 사용되지 않은 적립금은 각각 익년 1월1일, 7월1일 자동 소멸됩니다.</li>
					<li>“몰”은 사이버 머니 제휴업체와 회원의 사이버 머니 적립 및 사용을 위하여 필요한 최소한의 정보 (아이디, 기타 회원의 식별을 위하여 필요한 정보, 물품 배송의 경우 배송에 필요한 성명, 주소, 전화번호 등)를 제공하거나 받을 수 있습니다</li>
				</ol>
			</div><!-- box01 17 :: end -->
			...
			<div class="box01">
				...
				<ol class="termsOlist01 round">
					...
					<li>“몰”이 개인정보 수집 및 이용과 관련하여 이용자의 동의를 받아야 하는 경우에는 개인정보 수집 이용의 목적, 수집하는 개인정보의 항목, 개인정보의 보유 및 이용기간을 이용자에게 알리고 동의를 받으며 이용자는 언제든지 이 동의를 철회할 수 있습니다. 단, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 제22조 제2항에 따라 정보통신서비스의 제공에 관한 계약을 이행하기 위하여 필요한 개인정보로서 경제적 기술적 사유로 통상적인 동의를 받는 것이 뚜렷하게 곤란한 경우(접속로그, 통화사실기록, 이용정지기록 등)는 예외로 합니다.</li>
					...
					<li>“몰”은 개인정보 보호를 위하여 이용자의 개인정보를 처리하는 자를 최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한 이용자의 개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공, 변조 등으로 인한 이용자의 손해에 대하여 모든 책임을 집니다.</li>
			...
			<div class="box01">
				<h5>제21조 이용자의 의무</h5>
				<ol class="termsOlist01 round">
					<li>이용자는 재화 등을 구매하기 전에 반드시 “몰”에 게시되어 있는 재화 등의 상세 정보와 거래 조건을 정확하게 확인한 후 구매를 하여야 합니다. 구매하려는 재화 등의 내용과 거래의 조건 등을 확인하지 않고 구매하여 발생한 모든 손실은 이용자에게 귀속됩니다.</li>
					<li>
						...
						<br>5. “몰” 및 기타 제3자의 저작권 등 지적재산권에 대한 침해
						<br>6. “몰” 및 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위
						<br>7. 외설 또는 폭력적인 메시지,화상,음성,기타 공서양속에 반하는 정보를 “몰”에 공개 또는 게시하는 행위
						<br>8. 재판매 등의 목적으로 대량으로 재화를 구매하여 건전한 상거래 질서를 해하는 행위
						<br>9. 컴퓨터 등 정보처리장치에 허위의 정보 또는 부정한 명령을 입력하거나 권한 없이 정보를 입력 변경하여 정보처리를 하는 행위 (해킹 등)
						<br>10. “몰”을 이용하여 구입한 재화 등의 대금, 기타 “몰” 이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우
						<br>11. 제3자의 “몰” 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우
						<br>12. 서비스의 이용과정에서 회사의 직원에게 폭언, 협박 또는 음란한 언행 등 부적절한 방법으로 회사의 업무를 방해하는 경우
						<br>13. 재화 등을 구매한 후 정당한 이유 없이 상습적으로 취소, 교환 및 반품하여 회사의 업무를 방해하는 경우
					</li>
				</ol>
			</div><!-- box01 21 :: end -->

			<div class="box01">
				<h5>제22조(연결“몰”과 피연결“몰” 간의 관계)</h5>
				<ol class="termsOlist01 round">
